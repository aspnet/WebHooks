...
{
    /// <summary>
    /// An <see cref="Attribute"/> indicating the associated action is a Kudu WebHooks endpoint. Specifies the optional
    /// <see cref="WebHookActionAttributeBase.Id"/>. Also adds a <see cref="Filters.WebHookReceiverExistsFilter"/> for
    /// the action.
    /// </summary>
    public class KuduActionAttribute : WebHookActionAttributeBase
    {
        /// <summary>
        /// <para>
        /// Instantiates a new <see cref="KuduActionAttribute"/> indicating the associated action is a Kudu
        /// WebHooks endpoint.
        /// </para>
