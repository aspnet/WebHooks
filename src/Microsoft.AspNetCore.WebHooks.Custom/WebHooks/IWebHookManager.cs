...
namespace Microsoft.AspNetCore.WebHooks
{
    ...
    /// the <see cref="NotifyAsync(string, IEnumerable{IWebHookNotification}, Func{WebHook, string, bool})"/> method is called, 
    ...
    public interface IWebHookManager
    {
        ...
        Task<int> NotifyAsync(string user, IEnumerable<IWebHookNotification> notifications, Func<WebHook, string, bool> predicate);
        ...
        /// the <see cref="WebHook"/> is included; otherwise it is not.</param>
        /// <returns>The number of <see cref="WebHook"/> instances that were selected and subsequently notified about the actions.</returns>
        Task<int> NotifyAllAsync(IEnumerable<IWebHookNotification> notifications, Func<WebHook, string, bool> predicate);
    }
}
