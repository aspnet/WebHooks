...
namespace System.Web.Http
{
    ...
    public static class HttpConfigurationExtensions
    {
        ...
        /// 
        /// A sample WebHook URI is '<c>https://&lt;host&gt;/api/webhooks/incoming/tfs/{id}?code={code}</c>'.
        ...
        public static void InitializeReceiveTfsWebHooks(this HttpConfiguration config)
        {
