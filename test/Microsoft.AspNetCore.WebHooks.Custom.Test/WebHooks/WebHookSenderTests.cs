...
namespace Microsoft.AspNetCore.WebHooks.WebHooks
{
    public class WebHookSenderTests : IDisposable
    {
        ...
        private static WebHookWorkItem CreateWorkItem()
        {
            ...
            IWebHookNotification notification1 = new WebHookDataNotification("a1", new { d1 = "dv1" });
            IWebHookNotification notification2 = new WebHookDataNotification("a1", new Dictionary<string, object> { { "d2", new Uri("http://localhost/") } });
