            ...
            var expected = new WorkItemRestoredPayload
            {
                ...
                Resource = new WorkItemRestoredResource
                {
                    ...
                    Links = new WorkItemLinks
                    {
                        ...
                        Html = new WorkItemLink { Href = "https://fabrikam-fiber-inc.visualstudio.com/web/wi.aspx?pcguid=d81542e4-cdfa-4333-b082-1ae2d6c3ad16&id=5" },
                        WorkItemHistory = new WorkItemLink { Href = "https://fabrikam-fiber-inc.visualstudio.com/DefaultCollection/_apis/wit/workItems/5/history" }
                    },
